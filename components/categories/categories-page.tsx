  ...
  return (
    <div>
      <div className="container mx-auto pb-10">
        <div className="mb-8">
          <h1 className="text-3xl font-bold mb-2">Catégories de quiz</h1>
          <p className="text-muted-foreground">Parcourez les catégories et trouvez les quiz qui vous intéressent.</p>
        </div>

        {/* Search bar */}
        <div className="relative max-w-md mb-8">
          <Search className="absolute left-3 top-1/2 h-4 w-4 -translate-y-1/2 text-muted-foreground" />
          <Input placeholder="Rechercher une catégorie..." className="pl-10" value={searchQuery} onChange={(e) => setSearchQuery(e.target.value)} />
        </div>
        ...
        {filteredCategories.length === 0 && (
          <div className="text-center py-12">
            ...
            <p className="text-muted-foreground max-w-md mx-auto">Aucune catégorie ne correspond à "{searchQuery}". Essayez un autre terme.</p>
          </div>
        )}
      </div>
