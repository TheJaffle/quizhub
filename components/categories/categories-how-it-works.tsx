  ...
  const steps = [
    {
      ...
      description: "Explorez les thèmes disponibles et trouvez les quiz qui vous intéressent.",
    ...
    },
    {
      ...
      description: "Testez-vous avec des quiz de différents niveaux et formats.",
      image: "/placeholder.svg?height=200&width=300",
    ...
    },
    {
      ...
      title: "Progressez",
      description: "Suivez vos résultats, collectionnez des badges et améliorez votre classement.",
      image: "/placeholder.svg?height=200&width=300",
      ...
      <div className="container mx-auto xl:px-4">
        <div className="text-center mb-16">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }} viewport={{ once: true }} className="inline-flex items-center gap-2 bg-slate-100 dark:bg-slate-800 px-4 py-1.5 rounded-full mb-4">
            <span className="text-sm font-medium text-slate-800 dark:text-slate-200">Parcours simple</span>
          </motion.div>
          ...
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.2 }} viewport={{ once: true }} className="text-slate-600 dark:text-slate-400 max-w-2xl mx-auto">
            Commencer un quiz est simple. Suivez ces étapes pour trouver un thème et vous lancer.
          </motion.p>
        </div>
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.5, delay: 0.8 }} viewport={{ once: true }} className="mt-16 text-center">
          <p className="text-slate-600 dark:text-slate-400 mb-6">Prêt à commencer ? Parcourez les catégories, choisissez un thème et lancez un quiz.</p>
          <div className="inline-flex items-center gap-2 bg-slate-100 dark:bg-slate-800 px-4 py-2 rounded-full">
            ...
            <span className="text-sm font-medium text-slate-800 dark:text-slate-200">
              <span className="font-bold">2 500+</span> utilisateurs en ligne
            </span>
          </div>
        </motion.div>
      </div>
