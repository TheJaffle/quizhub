...
import { BarChart3, Clock, DollarSign, Edit, Eye, Grid3X3, List, MoreHorizontal, Search, Share2, Trash2, Users } from "lucide-react";
    ...
    <div className="space-y-6">
      ...
      {filteredQuizzes.length === 0 ? (
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-muted-foreground max-w-md mb-6">{searchQuery ? `No quizzes match your search "${searchQuery}". Try a different search term.` : "You don't have any quizzes with the selected filter. Try a different filter."}</p>
        </div>
      ) : (
        <>
          {/* Grid View */}
