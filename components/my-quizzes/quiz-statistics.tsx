            ...
            <Card>
              ...
              <CardContent>
                <div className="h-64 w-full">
                  <ResponsiveContainer width="100%" height="100%">
                    <PieChart>
                      <Pie data={quiz.stats.playerDemographics.ageGroups} cx="50%" cy="50%" labelLine={true} outerRadius={80} fill="#8884d8" dataKey="percentage" nameKey="group" label={({ name, percent }) => `${name}: ${((percent ?? 0) * 100).toFixed(0)}%`}>
