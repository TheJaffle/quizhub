...
<div id="euOverlay" style="display:none;position:fixed;inset:0;background:rgba(0,0,0,.6);z-index:100;align-items:center;justify-content:center;padding:12px;">
  <div style="background:var(--card);border:1px solid var(--line);border-radius:14px;padding:24px;width:min(920px,94vw);max-width:94vw;max-height:88vh;display:flex;flex-direction:column;gap:14px;">
    ...
    <div style="overflow:auto;flex:1;border:1px solid var(--line);border-radius:8px;">
      <table style="width:100%;min-width:820px;border-collapse:collapse;table-layout:fixed;">
