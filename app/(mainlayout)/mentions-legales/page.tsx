export const metadata = {
  title: "Mentions légales | QI-FREE",
  description: "Mentions légales du site QI-FREE édité par Wildspark.",
};
    ...
    <main className="container mx-auto px-4 py-12">
      <div className="max-w-3xl space-y-8">
        ...
        <section className="space-y-3">
          ...
          <p>Le site QI-FREE est édité par la société Wildspark.</p>
        ...
        <section className="space-y-3">
          ...
          <p>QI-FREE propose des quiz et tests gratuits. Aucun achat, abonnement payant, lot financier ou paiement en ligne n'est proposé sur le site.</p>
        </section>
